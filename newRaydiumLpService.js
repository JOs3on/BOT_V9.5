...
async function processRaydiumLpTransaction(conn, sig) {
    ...
    for (const ix of ixs) {
        ...
        // ADDED: Ensure WSOL flag is set correctly
        td.isWSOLSwap = (
            td.quoteMint === "So11111111111111111111111111111111111111112" ||
            td.baseMint === "So11111111111111111111111111111111111111112"
        );
        ...
        // Remove the old WSOL flag assignment since we've added a more comprehensive one
